...
--tahn, cosh, asinh, atanh, acosh

truAndFalse = True && False
...
listTimes2 = [x * 2 | x <- [1..100]]
dvidBy9N13 = [x | x <- [1..500], x `mod`13 == 0, x `mod` 9 == 0]

sortedList = sort [9,1,8,3,4,7,6,17,5,11,99,23,53,16,32]
